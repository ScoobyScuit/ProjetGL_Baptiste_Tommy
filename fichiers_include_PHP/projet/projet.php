...
<body id="project-page">
  <div class="profile-container">
    ...
    <nav class="navbar">
      ...
      <div class="settings">
        <button class="settings-btn" onclick="location.href = '/fichiers_include_PHP/parametre/settings.php';"
          style="display: none">
  ...
  <script type="module" src="/fichiers_include_PHP/projet/scriptproject.js"></script>
